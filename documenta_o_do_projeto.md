...
1. **Baixar o FFmpeg:**
   * Acesse o site oficial: [https://ffmpeg.org/download.html](https://ffmpeg.org/download.html)
   * Para Windows, recomenda-se baixar os binários pré-compilados no repositório [gyan.dev (ffmpeg-git-full.7z)](https://www.gyan.dev/ffmpeg/builds/).
...
* Acesse [https://nodejs.org/](https://nodejs.org/) e baixe a versão LTS (Long Term Support).
